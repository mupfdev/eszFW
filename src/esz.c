...
void esz_draw_frame(esz_window* window, esz_core* core)
{
    Uint32   delay;
    double   delta_time = 0.f;
    SDL_Rect dst;

    render_background(window, core);
    render_map(ESZ_BACKGROUND, window, core);

    // tbd.

    render_map(ESZ_FOREGROUND, window, core);
